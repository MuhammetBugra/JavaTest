...
public class Trace2 {
	 ...
	 private static int numCourses; // Number of courses taken so far
	 ...
	 public static void main(String[] args) {
		 ...
		 ahTeck.addCourseGrade("CENG104", 70);
		 ahTeck.printGrades();
		 System.out.printf("The average grade is %.2f%n", ahTeck.getAverageGrade());
		 System.out.println(numCourses);
		 Trace2 ahTeck2 = new Trace2("Uraz Yavanoglu", "Maltepe Turkey Turkey");
		 ...
		 ahTeck2.printGrades(); System.out.println(numCourses); } }